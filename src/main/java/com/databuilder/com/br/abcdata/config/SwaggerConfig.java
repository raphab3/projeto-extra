...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.databuilder.com.br.abcdata.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Software ABCData",
				"Esta API é utilizada para Gerenciamento de Escolas do Ensino Infantil, Fundamental e Médio", 
				"Versão 1.0",
				"https://www.databuilder.com.br/abcdata/terms",
				new Contact("Wendell Clive", "www.databuilder.com.br", "wendell.clive@databuilder.com.br"),
				"Exclusivo uso para Privado com Autorização e Locação da Databuilder Software House Ltda", 
				"https://www.databuilder.com.br/abcdata/terms", 
