...
public class DisciplinaController {
	...
	@ApiOperation(value = "Retorna Disciplinas até 24 linhas por pagina", notes = "Endpoint para CONSULTAR todas as Disciplinas paginadas.", response = Disciplina.class)
	@PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_PESQUISA_DISCIPLINA')")
